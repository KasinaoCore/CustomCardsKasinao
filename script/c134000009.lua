...
s.listed_names={134000008, 134000007}

function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(-100)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,Card.IsCode,1,false,aux.ReleaseCheckMMZ,nil,134000007) end
	local g=Duel.SelectReleaseGroupCost(tp,Card.IsCode,1,1,false,aux.ReleaseCheckMMZ,nil,134000007)
	Duel.Release(g,REASON_COST)
end
function s.spfilter(c,e,tp)
	return c:IsCode(134000008) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
